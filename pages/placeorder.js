...
export default function PlaceOrderScreen() {
    ...
    <Layout title="Place Order">
        ...
        <h1 className="4 text-xl">Place Order</h1>
        {cartItems.length === 0 ? (
            <div>
                            ...
                            <tbody>
                                {cartItems.map((item) => (
                                    <tr key={item._id} className="border-b">
                                        ...
                                        <td className="p5 text-right">{item.quantity}</td>
                                        <td className="p5 text-right">{item.price}</td>
                                        <td className="p5 text-right">${item.quantity * item.price}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
